...
impl<Id: EntityId> PropertyStorage<Id> {
    ...
    // Kept for targeted-rollback callers; currently unused under all-features.
    #[allow(dead_code)]
...
impl<Id: EntityId> PropertyColumn<Id> {
    ...
    // Rollback helper kept for API symmetry; currently unused under all-features.
    #[allow(dead_code)]
    ...
    // Savepoint-rollback helper kept for API symmetry; currently unused under all-features.
    #[allow(dead_code)]
