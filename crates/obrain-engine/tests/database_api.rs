...
// NOTE: test_iter_nodes removed 2026-07-02 — iter_nodes retired with the legacy single-file format (T17 Wave A, b0f5bd11).
// NOTE: test_iter_edges removed 2026-07-02 — iter_edges retired with the legacy single-file format (T17 Wave A, b0f5bd11).
// NOTE: test_iter_empty_database removed 2026-07-02 — iter_nodes/iter_edges retired with the legacy single-file format (T17 Wave A, b0f5bd11).
...
// NOTE: test_to_memory_clones_data removed 2026-07-02 — to_memory retired with the legacy single-file format (T17 Wave A, b0f5bd11).

// NOTE: the snapshot export/import roundtrip tests were removed 2026-07-02 —
// `ObrainDB::export_snapshot`/`import_snapshot` were retired with the legacy
// single-file .obrain format (T17 Wave A, commit b0f5bd11). Persistence
// round-trips are covered by wal_recovery.rs on the substrate format.
