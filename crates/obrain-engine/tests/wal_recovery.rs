...
//!
//! Covers: persistent open/close/reopen cycle, WAL recovery of
//! nodes/edges/properties/labels, and checkpoint operations.
//!
//! ```bash
...
mod wal {
    ...
    // NOTE: test_save_to_new_location removed 2026-07-02 — save retired with the legacy single-file format (T17 Wave A, b0f5bd11).
    // Persistent roundtrip coverage lives in test_persistent_db_roundtrip.
    // NOTE: test_open_in_memory_from_file removed 2026-07-02 — open_in_memory retired with the legacy single-file format (T17 Wave A, b0f5bd11).
    ...
    // NOTE: test_rdf_save_preserves_triples removed 2026-07-02 — save retired with the legacy single-file format (T17 Wave A, b0f5bd11).
    // RDF persistence coverage lives in test_rdf_triples_persist_across_restart and test_rdf_named_graph_persists_across_restart.

    // NOTE: test_save_preserves_named_graphs removed 2026-07-02 — save retired with the legacy single-file format (T17 Wave A, b0f5bd11).
    // Named-graph persistence coverage lives in test_named_graph_persists_across_restart and test_multiple_named_graphs_persist.
}
